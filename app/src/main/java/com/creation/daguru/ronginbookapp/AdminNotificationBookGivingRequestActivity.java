...
public class AdminNotificationBookGivingRequestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_notification_book_giving_request);
    ...
    private void handOverBookAndUpdateValidity(){
        ...
        NotificationDetails notificationDetails = new NotificationDetails(
                ...
                RONGIN_UID + "_" + String.valueOf(TYPE_NOTIFICATION_BOOK_RECEIVED)
        );
    ...
    private void updateOtherValidity(){
        ...
        databaseReference.orderByChild(DATABASE_DIR_USER_NOTIFICATION_CHILD_OTHER_UID_AND_NOTI_TYPE)
                .equalTo(RONGIN_UID + "_" + String.valueOf(TYPE_NOTIFICATION_BOOK_REQUEST_REPLY_ACCEPT ))
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.noti_give_book_true:
                //Toast.makeText(this, "vjh", Toast.LENGTH_LONG).show();
