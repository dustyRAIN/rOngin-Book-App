...
public class NotificationAccountFreezedActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView mtvbUserLibrary;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notification_account_freezed);
        ...
        mtvGeetUser = findViewById(R.id.noti_acc_freeze_greet_user);
        mtvbUserLibrary = findViewById(R.id.freeze_to_my_lib);
    ...
    private void setUpUI(){
        ...
        mtvbUserLibrary.setOnClickListener(this);
    }
