...
public class NotificationDayRequestAcceptedActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notification_day_request_accepted);
        ...
        mtvGeetUser = findViewById(R.id.noti_day_req_ac_greet_user);
        mtvBookName = findViewById(R.id.noti_day_req_ac_book_name);
        mtvAuthorName = findViewById(R.id.noti_day_req_ac_author);
        mtvDayNumber = findViewById(R.id.noti_day_req_ac_day_increased);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(photoUrl != null && !photoUrl.equals("") && !photoUrl.isEmpty()) {
                        ...
                        try {
                            Glide.with(NotificationDayRequestAcceptedActivity.this).load(photoUrl)
