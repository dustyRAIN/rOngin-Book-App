...
public class NotificationDayRequestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notification_day_request);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(photoUrl != null && !photoUrl.equals("") && !photoUrl.isEmpty()) {
                        ...
                        try {
                            Glide.with(NotificationDayRequestActivity.this).load(photoUrl)
        ...
        databaseReference.setValue(bookDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(NotificationDayRequestActivity.this,
    ...
    private void sendPositiveNotification(){
        ...
        notificationDetails.otherUId_notiType = mFirebaseUser.getUid() + "_" +
        ...
        notificationDetails.otherUserUId = mFirebaseUser.getUid();
        notificationDetails.otherUserName = mFirebaseUser.getDisplayName();
        ...
        databaseReference.child(key).setValue(notificationDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(NotificationDayRequestActivity.this, "Notification Sent.", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(NotificationDayRequestActivity.this,
