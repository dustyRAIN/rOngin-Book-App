...
public class NotificationDayRequestDeniedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notification_day_request_denied);
        ...
        mtvGeetUser = findViewById(R.id.noti_day_req_den_greet_user);
        mtvBookName = findViewById(R.id.noti_day_req_den_book_name);
        mtvAuthorName = findViewById(R.id.noti_day_req_den_author);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(photoUrl != null && !photoUrl.equals("") && !photoUrl.isEmpty()) {
                        ...
                        try {
                            Glide.with(NotificationDayRequestDeniedActivity.this).load(photoUrl)
    ...
    private void checkForIntentExtras(){
        ...
        if(getIntent().hasExtra(EXTRA_KEY_CREATE_TIME)){
            mNotificationDetails.createTime = getIntent().getLongExtra(EXTRA_KEY_CREATE_TIME, System.currentTimeMillis());
        }
