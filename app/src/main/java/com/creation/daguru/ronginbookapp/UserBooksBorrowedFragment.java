...
public class UserBooksBorrowedFragment extends Fragment implements UserExchangeBooksViewAdapter.ExchangeBookOnClickHandler {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_user_books_borrowed, container, false);
        mLoading = mView.findViewById(R.id.user_books_borrowed_loading);
        mRecyclerView = mView.findViewById(R.id.user_books_borrowed_recycler_view);
    ...
    public void onResume() {
        ...
        mAdapter = new UserExchangeBooksViewAdapter(getContext(),
                UserExchangeBooksViewAdapter.BORROWED_EXCHANGE_TYPE, mBookDetailsList, this);
    ...
    public void bookOnClicked(ListUserBookExchangeDetails bookExchangeDetails) {
        Intent borrowDetailsIntent = new Intent(getActivity(), BorrowedBookDetailsActivity.class);
        borrowDetailsIntent = addExtrasToIntent(borrowDetailsIntent, bookExchangeDetails);
        startActivity(borrowDetailsIntent);
    }
